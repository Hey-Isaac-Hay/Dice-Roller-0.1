...
namespace Dice_Roller_0._1.Pages
{
    ...
    public class CC1Model : PageModel
    {
        ...
        public void OnPostCCOneSubmit()
        {
            
            
            
            ViewData["CC1Data"] = "test";
        }
        public void OnPostTEST()
        {
            ...
            CC1Cookie.Path = "/";
            HttpContext.Response.Cookies.Append("your_mom_cookie", "your mom", CC1Cookie);

            ViewData["TESTVALUE"] = Request.Cookies["your_mom_cookie"];
            Console.WriteLine("test test test 123");
